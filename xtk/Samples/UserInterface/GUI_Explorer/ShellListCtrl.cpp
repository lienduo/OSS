...
BOOL CShellListCtrl::IsItemFiltered(LPCTSTR lpszItemName, ULONG ulItemAttrs)
{
	if (ulItemAttrs & SFGAO_FOLDER)
		return FALSE;
	
	// Apply your filter here.
	return CXTShellListCtrl::IsItemFiltered(lpszItemName, ulItemAttrs);
}