...
BEGIN_MESSAGE_MAP(CMainFrame, CFrameWnd)
	...
	ON_COMMAND_RANGE(ID_SKIN_LUNABLUE, ID_SKIN_DISABLE, OnSkinChanged)
	ON_COMMAND(ID_SKIN_POPUP, OnSkinPopup)
#endif
...
void CMainFrame::OnSkinChanged(UINT nID)
{
#ifdef _XTP_INCLUDE_SKINFRAMEWORK
	switch (nID)
	{
