...
protected:
	...
	afx_msg void OnDropdownFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnCloseupFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnSelchangeFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnSelendokFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnSetfocusFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnSelendcancelFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnKillfocusFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
	afx_msg void OnEditchangeFindCombo(NMHDR* pNMHDR, LRESULT* pRes);
