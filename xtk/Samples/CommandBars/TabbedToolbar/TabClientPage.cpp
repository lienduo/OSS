...
CTabManagerPage::CTabManagerPage()
	: CPropertyPage(CTabManagerPage::IDD)
{
...
void CTabManagerPage::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Check(pDX, IDC_CHECK_FILLBACKGROUND, m_bFillBackground);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CTabManagerPage, CPropertyPage)
	...
	ON_BN_CLICKED(IDC_CHECK_FILLBACKGROUND, OnCheckBackground)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
