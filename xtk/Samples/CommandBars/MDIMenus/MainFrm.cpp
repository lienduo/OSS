...
int CMainFrame::OnCreateControl(LPCREATECONTROLSTRUCT lpCreateControl)
{
	...
	if (pMenuBar)
	{
		...
		if (lpCreateControl->strCaption == _T("&Edit"))
		{
			...
			// Present only in IDR_MDIMENUTYPEEDIT and IDR_MDIMENUTYPEHTML template
			pControlPopup->AssignDocTemplate(IDR_MDIMENUTYPEEDIT);
			pControlPopup->AssignDocTemplate(IDR_MDIMENUTYPEHTML);
		...
		if (lpCreateControl->strCaption == _T("&Color"))
		{
			...
			// Present only in IDR_MDIMENUTYPECOLOR template
			pControlPopup->AssignDocTemplate(IDR_MDIMENUTYPECOLOR);
	...
	if (lpCreateControl->nID == ID_GOTO_URL)
	{
		...
		pComboUrl->AssignDocTemplate(IDR_MDIMENUTYPEHTML);
