...
CDialogNewToolbar::CDialogNewToolbar(BOOL bToolBar)
	: CDialog(CDialogNewToolbar::IDD, NULL)
{
...
BOOL CDialogNewToolbar::OnInitDialog()
{
	CDialog::OnInitDialog();

	if (!m_bToolBar)
	{
		SetWindowText(_T("New context menu"));
	}
