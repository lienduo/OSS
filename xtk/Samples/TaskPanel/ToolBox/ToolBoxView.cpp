...
int CToolBoxView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	m_wndPropertySheet.ModifyStyleEx(0, WS_EX_CONTROLPARENT);
	...
	m_wndPageLookAndBehaviour.ModifyStyle(0, DS_CONTROL);
	m_wndPageLookAndBehaviour.ModifyStyleEx(0, WS_EX_CONTROLPARENT);
