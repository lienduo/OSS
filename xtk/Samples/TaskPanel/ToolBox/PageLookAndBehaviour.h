...
class CPageLookAndBehaviour : public CPropertyPage
{
// Construction
public:
...
// Dialog Data
	...
	BOOL    m_bAllowDrag;
	BOOL	m_bShowGroupIcons;
	BOOL	m_bSmallGroupIcons;
...
protected:
	...
	afx_msg void OnCheckShowGroupIcons();
	afx_msg void OnCheckSmallGroupIcons();
