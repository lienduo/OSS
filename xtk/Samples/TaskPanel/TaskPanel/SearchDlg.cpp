...
BOOL CSearchDlg::OnInitDialog()
{
	...
	m_cboLookIn.Create(WS_CHILD|WS_VISIBLE|WS_BORDER|WS_VSCROLL|CBS_DROPDOWN, CRect(0, 0, 0, 60), &m_wndTaskPanel, 0);
	m_cboLookIn.SetFont(XTPPaintManager()->GetRegularFont());
	m_cboLookIn.AddString(_T("C:\\"));
	m_cboLookIn.AddString(_T("X:\\"));
	...
	m_dlgModified.CheckRadioButton(IDC_RADIO1, IDC_RADIO5, IDC_RADIO1);
	...
	m_dlgSize.CheckRadioButton(IDC_RADIO1, IDC_RADIO5, IDC_RADIO1);
