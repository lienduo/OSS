...
// Dialog Data
	...
	CXTResizeGroupBox m_gboxButton;
	CXTResizeGroupBox m_gboxPopup;
	CXTResizeGroupBox m_gboxDialog;
	CXTResizeGroupBox m_gboxTheme;
...
protected:
	...
	afx_msg void OnRadioOfficeXP();
	afx_msg void OnRadioOffice2003();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
