...
void CPropertyPageTaskPanelNavigator::SetFocusedItem(CXTPTaskPanelItem* pItem, BOOL bDrawFocusRect /*= FALSE*/)
{
	...
	CXTPTaskPanel::SetFocusedItem(pItem, bDrawFocusRect);
