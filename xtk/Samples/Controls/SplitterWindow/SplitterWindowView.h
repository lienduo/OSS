...
// class forwards
class CSplitterWindowDoc;

class CSplitterWindowView : public CView
{
protected: // create from serialization only
	CSplitterWindowView();
	DECLARE_DYNCREATE(CSplitterWindowView)

// Attributes
public:
	CSplitterWindowDoc* GetDocument();
