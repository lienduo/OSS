// ExcelEditCtrl.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(CExcelEditCtrl, CEdit)
	//{{AFX_MSG_MAP(CExcelEditCtrl)
	ON_WM_HSCROLL()
	ON_WM_CREATE()
	ON_WM_SIZE()
...
/////////////////////////////////////////////////////////////////////////////
// CExcelEditCtrl message handlers

void CExcelEditCtrl::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
...
CScrollBar* CExcelEditCtrl::GetScrollBarCtrl(int nBar) const
{
	if (nBar == SB_HORZ)
	{
...
int CExcelEditCtrl::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CExcelEditCtrl::OnSize(UINT nType, int cx, int cy)
{
...
void CExcelEditCtrl::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
