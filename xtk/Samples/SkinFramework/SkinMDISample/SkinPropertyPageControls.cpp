...
void CSkinPropertyPageControls::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_SCROLLBAR_DISABLED, m_sbarDisabled);
...
BOOL CSkinPropertyPageControls::OnInitDialog() 
{
	...
	m_sbarDisabled.SetScrollInfo(&info);
	...
	m_sbarDisabled.SetWindowPos(NULL, 0, 0, cx, cy, SWP_NOMOVE|SWP_FRAMECHANGED);
