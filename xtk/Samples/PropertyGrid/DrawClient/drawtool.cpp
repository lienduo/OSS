...
void CSelectTool::OnLButtonDown(CDrawView* pView, UINT nFlags, const CPoint& point)
{
	...
	((CMainFrame*)AfxGetMainWnd())->m_bInUpdate = TRUE;
	...
	((CMainFrame*)AfxGetMainWnd())->m_bInUpdate = FALSE;
	((CMainFrame*)AfxGetMainWnd())->UpdatePropertyGridContent(pView);
