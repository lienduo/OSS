	...
	: CDialog(CPropertiesDlg::IDD, pParent)
{
	...
	m_strOutputType = _T("Windows Application");
	...
	m_strClientScriptLanguage = _T("VBScript");
...
void CPropertiesDlg::CreateGridDesigner(HTREEITEM hItemCategory)
{
	...
	CXTPPropertyGridItem* pScriptLanguage = pCategoryScripting->AddChildItem(new CXTPPropertyGridItem(_T("Client Script Language"), m_strClientScriptLanguage, &m_strClientScriptLanguage));
	...
	m_wndGridDesigner.SetWindowPos(&m_wndProperties, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE|SWP_HIDEWINDOW);
}
...
void CPropertiesDlg::CreateGridBuild(HTREEITEM hItemCategory)
{
	...
	m_wndGridBuild.SetWindowPos(&m_wndProperties, 0, 0, 0, 0, SWP_NOMOVE|SWP_NOSIZE|SWP_HIDEWINDOW);
}
...
void CPropertiesDlg::OnOK()
{
	...
	afxDump << _T("m_strClientScriptLanguage = ") << m_strClientScriptLanguage << _T("\n");
