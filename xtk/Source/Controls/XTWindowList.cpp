...
CXTWindowList::CXTWindowList(HWND hWndMDIClient)
{
	InitModalIndirect(XTPResourceManager()->LoadDialogTemplate(XT_IDD_WINDOWLIST), 0);
...
void CXTWindowList::InsertMDIChild(HWND hwndMDIChildWnd)
{
