...
CXTPPropertyPageNavigator::CXTPPropertyPageNavigator()
{
	...
	m_rcPageMargin.SetRect(0, 0, 0, 0);
...
HBRUSH CXTPPropertyPageTabNavigator::GetPageBrush(CDC* pDC, CXTPPropertyPage* pPage)
{
	...
	if (GetPaintManager()->GetColor() == xtpTabColorWinXP)
	{
...
BEGIN_MESSAGE_MAP(CXTPPropertyPageListNavigator, CXTListBox)
...
void CXTPPropertyPageListNavigator::DrawItem(LPDRAWITEMSTRUCT lpDIS)
{
	CXTListBox::DrawItem(lpDIS);
}

void CXTPPropertyPageListNavigator::MeasureItem(LPMEASUREITEMSTRUCT lpMIS)
{
