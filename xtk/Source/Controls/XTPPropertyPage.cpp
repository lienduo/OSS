...
CXTPPropertyPage::CXTPPropertyPage()
	: CPropertyPage(), CXTResize(this, xtResizeNoClipChildren | xtResizeNoSizeIcon)
{
	CommonConstruct();
}
CXTPPropertyPage::CXTPPropertyPage(UINT nIDTemplate, UINT nIDCaption)
	: CPropertyPage(nIDTemplate, nIDCaption), CXTResize(this, xtResizeNoClipChildren | xtResizeNoSizeIcon)
{
	CommonConstruct();
}
CXTPPropertyPage::CXTPPropertyPage(LPCTSTR lpszTemplateName, UINT nIDCaption)
	: CPropertyPage(lpszTemplateName, nIDCaption), CXTResize(this, xtResizeNoClipChildren | xtResizeNoSizeIcon)
{
	CommonConstruct();
}
...
BOOL CXTPPropertyPage::CreatePage(CWnd* pParentWnd)
{
	...
	m_totalDev = m_hWnd ? CXTPWindowRect(this).Size() : CSize(0, 0);
...
void CXTPPropertyPage::AjustResizeRect(CSize& szWindow)
{
...
void CXTPPropertyPage::ScrollPage(int xAmount, int yAmount)
{
	...
	{
		CXTResizeRect& rrcWindow = m_arrItems[i]->m_rrcWindow;
