...
CXTPPopupThemeOffice2007::CXTPPopupThemeOffice2007()
{

}

void CXTPPopupThemeOffice2007::RefreshMetrics()
{
	CXTPPopupThemeOffice2003::RefreshMetrics();

	m_clrBackground.SetStandardValue(
		XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("BackgroundLight")),
		XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("BackgroundDark")));
	m_clrGripper.SetStandardValue(
		XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("CaptionLight")),
		XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("CaptionDark")));
	m_clrFrame.SetStandardValue(
		XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("FrameBorder")));

	m_clrText = XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("NormalText"));
	m_clrButtonSelected = XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("ButtonSelected"));
	m_clrButtonPressed = XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("ButtonPressed"));
	m_clrButtonPressedBorder.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("ButtonBorder")));
	m_clrButtonSelectedBorder.SetStandardValue(XTPOffice2007Images()->GetImageColor(_T("PopupControl"), _T("ButtonBorder")));
}
