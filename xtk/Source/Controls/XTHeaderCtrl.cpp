...
void CXTHeaderCtrl::SetImageManager(CXTPImageManager* pImageManager)
{
	CMDTARGET_RELEASE(m_pImageManager);
...
LRESULT CXTHeaderCtrl::OnPrintClient(WPARAM wParam, LPARAM /*lParam*/)
{
	CDC* pDC = CDC::FromHandle((HDC)wParam);
	if (pDC && IsThemeValid())
	{
		GetTheme()->DrawHeader(pDC, this);
		return TRUE;
	}
