...
void CXTTabBaseTheme::AdjustBorders(CXTTabBase* pTabCtrl, CXTTcbItem* pMember)
{
...
void CXTTabBaseThemeOfficeXP::AdjustBorders(CXTTabBase* pTabCtrl, CXTTcbItem* pMember)
{
	if (pMember && ::IsWindow(pMember->pWnd->GetSafeHwnd()) && pTabCtrl->m_bXPBorder)
	{
