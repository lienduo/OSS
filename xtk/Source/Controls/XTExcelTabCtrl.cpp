...
LRESULT CXTExcelTabCtrl::OnPrintClient(WPARAM wParam, LPARAM /*lParam*/)
{
...
void CXTExcelTabCtrl::OnDraw(CDC* pDC)
{
	...
	pDC->FillSolidRect(0, (m_dwStyle & FTS_XT_BOTTOM) ? rectPaint.top : rectPaint.bottom - 1,
		rectPaint.Width(), 1, GetTheme()->m_clr3DShadow);
	...
	for (i = 0; i < BUTTON_COUNT; ++i)
	{
		...
		{
			GetTheme()->DrawButton(pDC, this, m_buttons[i]);
		}
	}
