...
void CXTPTaskPanelShortcutBarOffice2007Theme::RefreshMetrics()
{
	...
	if (pImage)
	{
		m_clrShortcutItemShadow = XTPOffice2007Images()->GetImageColor(_T("ShortcutBar"), _T("FrameBorder"));
...
{
	CXTPOffice2007Image* pImage = XTPOffice2007Images()->LoadFile(rc.Height() > 22 ? _T("TOOLBARBUTTONS50") : _T("TOOLBARBUTTONS22"));
	if (!pImage)
	{
