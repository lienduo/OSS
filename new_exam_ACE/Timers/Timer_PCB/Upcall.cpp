...
int UpcallHandler::timeout (PTimerQueue &,
                PCB *handler,
                const void *arg,
                int /* recurring_timer */,
...
int UpcallHandler::deletion (PTimerQueue &,
                PCB *handler,
                const void *)
{
...
int UpcallHandler::registration (PTimerQueue &,
                PCB *handler,
                const void *)
{
...
int UpcallHandler::preinvoke (PTimerQueue &,
                PCB *handler,
                const void *,
                int,
                const ACE_Time_Value &,
...
int UpcallHandler::postinvoke (PTimerQueue &,
                PCB *handler,
                const void *,
                int,
                const ACE_Time_Value &,
...
int UpcallHandler::cancel_type (PTimerQueue &,
                PCB *handler,
                int dont_call,
                int &)
{
...
int UpcallHandler::cancel_timer (PTimerQueue &,
                PCB *handler,
                int dont_call,
                int)
{
